...
import { getSessionResponseSchemaSchema } from "./get-session-response-schema-schema.ts";
 ...
 */
export const getApiV1AuthSession200Schema = z
  .lazy(() => getSessionResponseSchemaSchema)
  .describe("Get session response description");

/**
 * @description Bad request
 */
export const getApiV1AuthSession400Schema = z
 ...
 */
export const getApiV1AuthSession401Schema = z
 ...
 */
export const getApiV1AuthSession402Schema = z
 ...
 */
export const getApiV1AuthSession403Schema = z
 ...
 */
export const getApiV1AuthSession404Schema = z
 ...
 */
export const getApiV1AuthSession500Schema = z
  .lazy(() => internalServerErrorResponseSchemaSchema)
  .describe("Internal server error response description");

export const getApiV1AuthSessionQueryResponseSchema = z.lazy(
