 ...
 */
export const getApiV1BillingPaymentsMy200Schema = z
  .lazy(() => getMyPaymentsResponseSchemaSchema)
  .describe("Get my payments response description");

/**
 * @description Bad request
 */
export const getApiV1BillingPaymentsMy400Schema = z
 ...
 */
export const getApiV1BillingPaymentsMy403Schema = z
 ...
 */
export const getApiV1BillingPaymentsMy404Schema = z
 ...
 */
export const getApiV1BillingPaymentsMy500Schema = z
  .lazy(() => internalServerErrorResponseSchemaSchema)
  .describe("Internal server error response description");

export const getApiV1BillingPaymentsMyQueryResponseSchema = z.lazy(
