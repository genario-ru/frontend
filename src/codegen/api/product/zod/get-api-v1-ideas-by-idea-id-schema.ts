...
import { getIdeaResponseSchemaSchema } from "./get-idea-response-schema-schema.ts";
...
export const getApiV1IdeasByIdeaIdPathParamsSchema = z.object({
  ideaId: z.uuid(),
});
 ...
 */
export const getApiV1IdeasByIdeaId200Schema = z
  .lazy(() => getIdeaResponseSchemaSchema)
  .describe("Get idea response description");

/**
 * @description Bad request
 */
export const getApiV1IdeasByIdeaId400Schema = z
 ...
 */
export const getApiV1IdeasByIdeaId401Schema = z
 ...
 */
export const getApiV1IdeasByIdeaId402Schema = z
 ...
 */
export const getApiV1IdeasByIdeaId403Schema = z
 ...
 */
export const getApiV1IdeasByIdeaId404Schema = z
 ...
 */
export const getApiV1IdeasByIdeaId500Schema = z
  .lazy(() => internalServerErrorResponseSchemaSchema)
  .describe("Internal server error response description");

export const getApiV1IdeasByIdeaIdQueryResponseSchema = z.lazy(
