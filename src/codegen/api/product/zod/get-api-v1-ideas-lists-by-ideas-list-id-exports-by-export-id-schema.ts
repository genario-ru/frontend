...
export const getApiV1IdeasListsByIdeasListIdExportsByExportIdPathParamsSchema =
  z.object({
    ideasListId: z.uuid(),
    exportId: z.uuid(),
  });
 ...
 */
export const getApiV1IdeasListsByIdeasListIdExportsByExportId200Schema = z
 ...
 */
export const getApiV1IdeasListsByIdeasListIdExportsByExportId400Schema = z
 ...
 */
export const getApiV1IdeasListsByIdeasListIdExportsByExportId401Schema = z
 ...
 */
export const getApiV1IdeasListsByIdeasListIdExportsByExportId403Schema = z
 ...
 */
export const getApiV1IdeasListsByIdeasListIdExportsByExportId404Schema = z
 ...
 */
export const getApiV1IdeasListsByIdeasListIdExportsByExportId500Schema = z
  .lazy(() => internalServerErrorResponseSchemaSchema)
  .describe("Internal server error response description");

export const getApiV1IdeasListsByIdeasListIdExportsByExportIdQueryResponseSchema =
  z.lazy(() => getApiV1IdeasListsByIdeasListIdExportsByExportId200Schema);
