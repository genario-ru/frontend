...
import { getProductFeaturesResponseSchemaSchema } from "./get-product-features-response-schema-schema.ts";
 ...
 */
export const getApiV1ProductFeatures200Schema = z
  .lazy(() => getProductFeaturesResponseSchemaSchema)
  .describe("Get product features response description");

/**
 * @description Bad request
 */
export const getApiV1ProductFeatures400Schema = z
 ...
 */
export const getApiV1ProductFeatures401Schema = z
 ...
 */
export const getApiV1ProductFeatures402Schema = z
 ...
 */
export const getApiV1ProductFeatures403Schema = z
 ...
 */
export const getApiV1ProductFeatures404Schema = z
 ...
 */
export const getApiV1ProductFeatures500Schema = z
  .lazy(() => internalServerErrorResponseSchemaSchema)
  .describe("Internal server error response description");

export const getApiV1ProductFeaturesQueryResponseSchema = z.lazy(
