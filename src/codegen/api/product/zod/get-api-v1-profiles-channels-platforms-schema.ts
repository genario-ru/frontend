...
import { getPlatformsForChannelsResponseSchemaSchema } from "./get-platforms-for-channels-response-schema-schema.ts";
 ...
 */
export const getApiV1ProfilesChannelsPlatforms200Schema = z
  .lazy(() => getPlatformsForChannelsResponseSchemaSchema)
  .describe("Get platforms for channels response description");

/**
 * @description Bad request
 */
export const getApiV1ProfilesChannelsPlatforms400Schema = z
 ...
 */
export const getApiV1ProfilesChannelsPlatforms401Schema = z
 ...
 */
export const getApiV1ProfilesChannelsPlatforms402Schema = z
 ...
 */
export const getApiV1ProfilesChannelsPlatforms403Schema = z
 ...
 */
export const getApiV1ProfilesChannelsPlatforms404Schema = z
 ...
 */
export const getApiV1ProfilesChannelsPlatforms500Schema = z
  .lazy(() => internalServerErrorResponseSchemaSchema)
  .describe("Internal server error response description");

export const getApiV1ProfilesChannelsPlatformsQueryResponseSchema = z.lazy(
