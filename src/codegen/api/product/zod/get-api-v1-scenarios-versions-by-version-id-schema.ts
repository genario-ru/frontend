...
import { getScenarioVersionResponseSchemaSchema } from "./get-scenario-version-response-schema-schema.ts";
...
export const getApiV1ScenariosVersionsByVersionIdPathParamsSchema = z.object({
  versionId: z.uuid(),
});
 ...
 */
export const getApiV1ScenariosVersionsByVersionId200Schema = z
  .lazy(() => getScenarioVersionResponseSchemaSchema)
  .describe("Get scenario version response description");

/**
 * @description Bad request
 */
export const getApiV1ScenariosVersionsByVersionId400Schema = z
 ...
 */
export const getApiV1ScenariosVersionsByVersionId401Schema = z
 ...
 */
export const getApiV1ScenariosVersionsByVersionId402Schema = z
 ...
 */
export const getApiV1ScenariosVersionsByVersionId403Schema = z
 ...
 */
export const getApiV1ScenariosVersionsByVersionId404Schema = z
 ...
 */
export const getApiV1ScenariosVersionsByVersionId500Schema = z
  .lazy(() => internalServerErrorResponseSchemaSchema)
  .describe("Internal server error response description");

export const getApiV1ScenariosVersionsByVersionIdQueryResponseSchema = z.lazy(
