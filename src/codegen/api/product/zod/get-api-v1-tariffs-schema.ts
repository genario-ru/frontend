...
import { getTariffsResponseSchemaSchema } from "./get-tariffs-response-schema-schema.ts";
 ...
 */
export const getApiV1Tariffs200Schema = z
  .lazy(() => getTariffsResponseSchemaSchema)
  .describe("Get tariffs response description");

/**
 * @description Bad request
 */
export const getApiV1Tariffs400Schema = z
 ...
 */
export const getApiV1Tariffs401Schema = z
 ...
 */
export const getApiV1Tariffs402Schema = z
 ...
 */
export const getApiV1Tariffs403Schema = z
 ...
 */
export const getApiV1Tariffs404Schema = z
 ...
 */
export const getApiV1Tariffs500Schema = z
