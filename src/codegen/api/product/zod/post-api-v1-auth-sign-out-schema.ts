...
import { signOutResponseSchemaSchema } from "./sign-out-response-schema-schema.ts";
import { unauthorizedResponseSchemaSchema } from "./unauthorized-response-schema-schema.ts";

/**
 * @description Signed out successfully
 */
export const postApiV1AuthSignOut200Schema = z
  .lazy(() => signOutResponseSchemaSchema)
  .describe("Sign out response description");

/**
 * @description Bad request
 */
export const postApiV1AuthSignOut400Schema = z
 ...
 */
export const postApiV1AuthSignOut401Schema = z
 ...
 */
export const postApiV1AuthSignOut402Schema = z
 ...
 */
export const postApiV1AuthSignOut403Schema = z
 ...
 */
export const postApiV1AuthSignOut404Schema = z
 ...
 */
export const postApiV1AuthSignOut500Schema = z
  .lazy(() => internalServerErrorResponseSchemaSchema)
  .describe("Internal server error response description");

export const postApiV1AuthSignOutMutationResponseSchema = z.lazy(
