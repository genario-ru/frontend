...
export function WaitlistLandingHeroPreview() {
  return (
    <div className="rounded-6 bg-neutral-1/20 shadow-bottom-2 dark:bg-neutral-8/20 relative w-full overflow-hidden p-3 backdrop-blur-xl">
      <Island>
        <div className="flex items-start justify-between gap-4">
          <p className="max-w-sm text-lg leading-tight font-semibold sm:text-xl">
            {WAITLIST_LANDING_HERO_PREVIEW_TITLE}
          </p>
          <SparklesIcon className="text-accent-7 size-5 shrink-0" />
        </div>
