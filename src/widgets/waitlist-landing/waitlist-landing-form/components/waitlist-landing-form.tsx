...
import { WaitlistLandingFormInterestsSkeleton } from "@/features/waitlist-landing/waitlist-landing-form/components/waitlist-landing-form-interests-skeleton";
...
import { WaitlistLandingFormSuccess } from "@/features/waitlist-landing/waitlist-landing-form/components/waitlist-landing-form-success";
import {
...
import { prepareWaitlistLandingFormInterests } from "@/features/waitlist-landing/waitlist-landing-form/utils/prepare-waitlist-landing-form-interests";
...
export function WaitlistLandingForm() {
  ...
  const { form, onFormSubmit, isApplicationCreating, isApplicationSubmitted } =
    useWaitlistLandingForm();

  const formInterestItems =
    prepareWaitlistLandingFormInterests(productFeatures);
          ...
          <form onSubmit={onFormSubmit} className="flex w-full flex-col gap-4">
            ...
            <form.AppForm>
              <form.SubmitButton
                size="lg"
                variant="accent"
                state={isApplicationCreating ? "loading" : "default"}
                className="w-full"
              >
                {WAITLIST_LANDING_FORM_SUBMIT_TEXT}
              </form.SubmitButton>
